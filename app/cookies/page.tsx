...
export default function CookiePreferences() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <button onClick={() => window.history.back()} className="mr-4 flex items-center">
        <ArrowLeft className="h-6 w-6 text-gray-600 mt-[-20px] hover:text-gray-900" />
      </button>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="advertising" className="flex flex-col space-y-1">
                ...
                <span className="font-normal text-sm text-muted-foreground">
                  These cookies are used to serve you with personalized
                  advertisements.
                </span>
              </Label>
              <Switch
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="why-use-cookies">
              ...
              <AccordionContent>
                ...
                <ul className="list-disc list-inside mt-2">
                  ...
                  <li>
                    To deliver personalized advertisements (if you consent)
                  </li>
                </ul>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="manage-cookies">
              ...
              <AccordionContent>
                ...
                Additionally, most web browsers allow you to control cookies
