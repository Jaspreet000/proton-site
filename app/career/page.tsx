  ...
  return (
    ...
    <div className="bg-gray-50 py-16 px-6 sm:px-12 lg:px-24">
        ...
        >
          {[
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 + index * 0.2 }}
            >
              <p className="text-gray-600 mb-4">"{employee.testimonial}"</p>
      ...
      <section className="text-center mb-24">
        ...
        >
          Explore our open positions and take the first step towards an exciting career with ProtonDataLabs.
        </motion.p>
        <motion.a
          href="/apply"
