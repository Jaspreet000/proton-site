  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl my-4 mt-5 md:text-5xl font-bold dark:text-white text-center mb-[30px]">Our Advisor</h2>
        <Card className="max-w-[90%] mx-auto border-none shadow-lg">
          <CardHeader className="pb-4">
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                ...
                <Badge variant="secondary">Network Science</Badge>
                <Badge variant="secondary">Neuroimaging</Badge>
                <Badge variant="secondary">Information Systems</Badge>
              </div>
            </div>
          </CardHeader>
