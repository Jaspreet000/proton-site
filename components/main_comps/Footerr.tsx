    ...
    <footer className="bg-white text-gray-700 py-10 mt-9">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 pr-2 lg:ml-[-50px]">
            ...
            <p className="text-sm text-center text-gray-500 mb-4">
              Copyright © 2021 Proton Datalabs
              <br />
              All rights reserved
            </p>
          </div>
            ...
            <ul>
              <li>
                <Link href="#" legacyBehavior passHref>
                  <span className="text-gray-500 hover:text-gray-700 block mb-2">
                    Home
                  </span>
                </Link>
              </li>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 mt-[-40px]">
            <div className="flex flex-col h-[130px] pt-[30px]">
              <p className="text-[14px] mt-5">
                You can also reach us by clicking the button below
              </p>
              <button
                className="bg-blue-950 dark:bg-white rounded-[12px] w-fit h-[34px] text-[12px] text-white dark:text-black px-4 py-2 mt-[12px]"
            ...
            <div className="flex space-x-4 mt-10">
              ...
              <Link
                href="https://www.linkedin.com/in/protondatalabs/"
                className="text-gray-500 hover:text-gray-700"
              >
                <FaLinkedin className="h-6 w-6" />
              </Link>
              <Link
                href="https://x.com/Proton_Datalabs"
                className="text-gray-500 hover:text-gray-700"
              >
        ...
        <div className="flex flex-wrap justify-center items-center mt-6 text-sm text-gray-500">
          <div className="flex flex-wrap justify-center gap-4 w-full sm:w-[90%] text-center">
            <span>
